...
def main() -> None:
    ...
    # 4. Output Kotlin
    with open(repo_root / "java/src/org/futo/inputmethod/latin/uix/settings/pages/credits/Contributors.kt", "w") as of:
        of.write("// Generated by tools/contributors.py, please do not update manually.\n")
        of.write("package org.futo.inputmethod.latin.uix.settings.pages.credits\n")
        of.write("\n")
        of.write(to_kotlin_list("languageContribs", lang_lines))
        of.write("\n")
        of.write(to_kotlin_list("layoutContribs", layout_authors))
        of.write("\n")
        of.write(to_kotlin_list("codeContribs", code_authors))
